...
<html>
  <head>
	...
	<link href="css/showEdit.css" rel="stylesheet"/>
  </head>
  ...
  <body>
  	...
  	<div class="wrapped">
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu" role="menu"
								...
								<li role="presentation">
									<a href="ucp/ucp.action" role="menuitem" tabindex="-1">个人中心</a>
								</li>
								<li role="presentation">
		...
		<div id="zxMain">
			<div id="button">
				<a id="submit" class="btn btn-primary">编辑</a>
				<input type="hidden" id="picID" value="0">
			</div>		
			<ul class="forPic">
			<s:iterator var="Pics" value="#session.photoZX" status="number">
				<li class="containerZX">
					<a class="pic">
						<img class="picZX" src=<s:property value="#Pics.picsUrl"/> id=<s:property value="#Pics.picId"/>>

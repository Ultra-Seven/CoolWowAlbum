...
<html>
  ...
  <body style="OVERFLOW-X: hidden; ">
  	...
  	<div class="wrapped">
		...
		<div id="zxMain">		
			<s:iterator var="Shares" value="#session.sharePics" status="number">
				<s:if test="%{#number.count%4==1}">
					<ul class="forPic">
				</s:if>
				<li class="containerZX" id=<s:property value="#Shares.id"/>>
					<div class="moveZX" id=<s:property value="#Shares.pictureId"/>>
						<img class="picZX" src=<s:property value="#Shares.url"/>>
						<div class="showInfor">
							<span class="picname"><s:property value="#Shares.name"/></span>
							<span class="author">by <s:property value="#Shares.master"/></span>
						</div>
						<div class="aixin">
							<a class="xc-bt-like xc-liked" title="取消喜欢"></a>
						</div>
					</div>
				</li>

...
import com.fudan2015.dao.ICommentUDao;
import com.fudan2015.entity.Comment;
import com.fudan2015.util.JdbcUtil;

public class CommentUDaoImpl implements ICommentUDao {
	private JdbcUtil util;
	public CommentUDaoImpl() {
		util=new JdbcUtil();
	}
	...
	public void addComment(Comment com) {
		...
		//插入语句
		String sql="insert into comments_infor_u (comment,observer,date,picId)values(?,?,now(),?)";
	...
	public void deleteComment(int id) {
		...
		Connection con=util.getConnection();
		//删除语句
		String sql="delete from comments_infor_u where id='"+id+"'";
		PreparedStatement pst=null;
		try {
			//执行语句
			pst=con.prepareStatement(sql);
	...
	public List<Comment> showCommentAll(int picId) {
		...
		String sql="select id,comment,observer,date from comments_infor_u where picId='"+picId+"'";
		PreparedStatement pst=null;
		ResultSet rs=null;
		try {
